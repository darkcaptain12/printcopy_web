...
<div class="flex justify-between items-center mb-6">
    ...
    <a href="create.php" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">Add Category</a>
</div>
    ...
    <table class="w-full">
        ...
        <tbody>
            ...
            <tr class="border-b hover:bg-gray-50">
                ...
                <td class="py-3 px-4 font-bold"><?= htmlspecialchars($row['name']) ?></td>
